...
function rewardTile(b,earned){return '<div class="reward-tile '+(earned?'earned':'locked')+'><img src="'+b.image+'" alt="'+(earned?b.badgeName||b.name:'ひみつのバッジ')+'" loading="lazy"><span>'+(earned?b.badgeName||b.name:'？？？')+'</span></div>';}
